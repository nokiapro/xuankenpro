...
async function reloadAll() {
  try {
    ...
    renderDashboard();
    // Đồng bộ số đếm sidebar (menus / cosplayers / tags / comments) ngay khi vào admin
...
/** Cập nhật badge số trên menu admin mà không cần mở từng tab */
...
/** Xuất sitemap.xml (SEO) từ photos + videos */
...
/* Admin mobile drawer (giống index) */
